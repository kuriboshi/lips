 ...
 */
LISPT* markobjs[] = {&top, &rstack, &history, &histnum, &fun, &expression,
  &args, &path, &home, &verboseflg, &topprompt, &promptform, &brkprompt,
  &currentbase, &interactive, &version, &gcgag, &alias_expanded, &C_EOF, NULL};
