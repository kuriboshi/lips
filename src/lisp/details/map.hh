...
lisp_t map(const lisp_t&, const lisp_t&, const lisp_t&);
lisp_t mapc(const lisp_t&, const lisp_t&, const lisp_t&);
lisp_t maplist(const lisp_t&, const lisp_t&, const lisp_t&);
