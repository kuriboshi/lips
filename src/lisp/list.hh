...
/// @lisp{(car a),Function}
inline lisp_t car(lisp_t a) { return details::list::car(a); }
/// @brief The cdr of the cons cell.
/// @lisp{(cdr a),Function}
inline lisp_t cdr(lisp_t a) { return details::list::cdr(a); }
/// @brief Same as (car (cdr a))
/// @lisp{(cadr a),Function}
inline lisp_t cadr(lisp_t a) { return details::list::cadr(a); }
/// @brief Same as (cdr (car a))
/// @lisp{(cdar a),Function}
inline lisp_t cdar(lisp_t a) { return details::list::cdar(a); }
/// @brief Same as (car (car a))
/// @lisp{(caar a),Function}
inline lisp_t caar(lisp_t a) { return details::list::caar(a); }
/// @brief Same as (cdr (cdr a))
/// @lisp{(cddr a),Function}
inline lisp_t cddr(lisp_t a) { return details::list::cddr(a); }
/// @brief Same as (cdr (cdr (cdr a)))
/// @lisp{(cdddr a),Function}
inline lisp_t cdddr(lisp_t a) { return details::list::cdddr(a); }
/// @brief Same as (car (cdr (cdr a)))
/// @lisp{(caddr a),Function}
inline lisp_t caddr(lisp_t a) { return details::list::caddr(a); }
/// @brief Same as (cdr (car (cdr a)))
/// @lisp{(cdadr a),Function}
inline lisp_t cdadr(lisp_t a) { return details::list::cdadr(a); }
/// @brief Same as (car (car (cdr a)))
/// @lisp{(caadr a),Function}
inline lisp_t caadr(lisp_t a) { return details::list::caadr(a); }
/// @brief Same as (cdr (cdr (car a)))
/// @lisp{(cddar a),Function}
inline lisp_t cddar(lisp_t a) { return details::list::cddar(a); }
/// @brief Same as (car (cdr (car a)))
/// @lisp{(cadar a),Function}
inline lisp_t cadar(lisp_t a) { return details::list::cadar(a); }
/// @brief Same as (cdr (car (car a)))
/// @lisp{(cdaar a),Function}
inline lisp_t cdaar(lisp_t a) { return details::list::cdaar(a); }
/// @brief Same as (car (car (car a)))
/// @lisp{(caaar a),Function}
inline lisp_t caaar(lisp_t a) { return details::list::caaar(a); }
/// @brief Same as `append` but modifies the arguments _args_.
/// @lisp{(nconc args...),NoSpread Function}
inline lisp_t nconc(lisp_t args) { return details::list::nconc(args); }
...
inline lisp_t attach(lisp_t a, lisp_t b) { return details::list::attach(a, b); }
/// @brief `t` if _x_ is `nil`, otherwise `nil`.
/// @lisp{(null a),Function}
inline lisp_t null(lisp_t a) { return details::list::null(a); }
/// @brief Create a list of the items _args_.
/// @lisp{(list args...),NoSpread Function}
inline lisp_t list(lisp_t a) { return details::list::list(a); }
/// @brief Returns the length of the list _l_.
/// @lisp{(length list),Function}
inline lisp_t length(lisp_t list) { return details::list::length(list); }
...
///   => nil
/// ```
inline lisp_t nth(lisp_t a, lisp_t b) { return details::list::nth(a, b); }
/// @brief Replaces `car` of _x_ with _y_ destructively.
/// @lisp{(rplaca x y),Function}
inline lisp_t rplaca(lisp_t x, lisp_t y) { return details::list::rplaca(x, y); }
/// @brief Replaces `cdr` of _x_ with _y_ destructively.
/// @lisp{(rplacd x y),Function}
inline lisp_t rplacd(lisp_t x, lisp_t y) { return details::list::rplacd(x, y); }
...
///   => (a b c d e f)
/// ```
inline lisp_t append(lisp_t a) { return details::list::append(a); }
...
/// are destructive.
inline lisp_t tconc(lisp_t l, lisp_t o) { return details::list::tconc(l, o); }
} // namespace lisp
